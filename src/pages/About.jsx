...
export default function About() {
  return (
    <div className="px-5 pb-4 max-w-2xl mx-auto">
      ...
      <h1 className="font-heading text-3xl font-bold tracking-tight mb-6">About Washek Fitness</h1>
      ...
      <div className="mt-8 rounded-xl border border-border bg-card p-5">
        <h2 className="font-heading font-semibold text-lg mb-3">Key Features</h2>
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li>• Personalized calisthenics, weightlifting, and hybrid programs</li>
          <li>• Kael AI coach with persistent memory and plan-aware advice</li>
          <li>• Precision nutrition tracking with food scanning and macros</li>
          <li>• AI-powered form analysis via video upload</li>
          <li>• Progress photos with body composition insights</li>
          <li>• Movement baseline tracking for all major lifts and holds</li>
        </ul>
      </div>
    </div>
  );
